...
class AppService extends AbstractService
{
     ...
     * @var string
     */
    const SERVICE_CLASS = 'AppserverIo\Appserver\Core\Api\AppService';
     ...
     *
     * @param \AppserverIo\Http\HttpPart $part The file data
     *
     * @return void
     */
     ...
     *
     * @return void
     * @see \AppserverIo\Api\Service\AbstractService::delete()
     */
